					...
					<div className="absolute top-full left-0 mt-2 w-80 bg-gray-800 rounded-lg shadow-lg border border-gray-600 z-50">
						<div className="p-4">
							<div className="flex items-center justify-between mb-4">
								<h3 className="text-lg font-semibold text-gray-100">Filter Buku</h3>
								<button
							...
							{filterType && (
								<div className="mb-4 relative">
									<label className="block text-sm font-medium text-gray-300 mb-2">
										{filterType === 'penulis' && 'Nama Penulis:'}
										{filterType === 'penerbit' && 'Nama Penerbit:'}
										{filterType === 'tahun' && 'Tahun Terbit:'}
									</label>
									<div className="relative">
										<input
											type={filterType === 'tahun' ? 'number' : 'text'}
											value={filterValue}
											onChange={(e) => handleFilterValueChange(e.target.value)}
											placeholder={
												filterType === 'penulis' ? 'Ketik nama penulis...' :
												filterType === 'penerbit' ? 'Ketik nama penerbit...' :
												'Ketik tahun...'
											}
