    ...
    async function fetchBookDetail() {
      try {
        ...
        const transformedBook = {
          ...
          penulis: data.Buku_Penulis?.map(bp => bp.Penulis?.nama_penulis).filter(Boolean) || []
        };
        ...
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <div className="rounded bg-slate-700 px-3 py-1">
                <span className="text-gray-400">Tahun:</span> {formatYear(book.tahun_terbit)}
              </div>
              <div className="rounded bg-slate-700 px-3 py-1">
                <span className="text-gray-400">Halaman:</span> {book.jumlah_halaman}
              </div>
            </div>
